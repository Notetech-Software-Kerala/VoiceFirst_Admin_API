...
namespace VoiceFirst_Admin.Data.Contracts.IRepositories
{
    ...
    {
        Task<BulkUpsertResult?> CreateAsync(SysUserCustomField entity, List<SysUserCustomFieldValidations> validations, List<SysUserCustomFieldOptions> options, int createdBy, CancellationToken cancellationToken = default);
